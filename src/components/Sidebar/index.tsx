          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        href="#"
                        className={`group relative flex  items-center gap-2.5 rounded-sm bg-white px-4 py-2 font-medium text-black duration-300 ease-in-out hover:bg-slate-300 dark:hover:bg-meta-4 ${
                          (pathname === "/" ||
              ...
              <li>
                <Link
                  href="/finance"
                  className="group relative flex items-center gap-2.5 rounded-sm bg-white px-4 py-2 font-medium text-black duration-300 ease-in-out hover:bg-slate-300"
                >
                  Finance
                </Link>
                <Link
